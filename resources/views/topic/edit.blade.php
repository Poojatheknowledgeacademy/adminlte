                ...
                <div class="timeline">
                    @foreach ($log as $logItem)
                        <div class="time-label">
                            <span class="bg-green">{{ $logItem->created_at->format('j F, Y') }}</span>
                        </div>
                        <div>
                            <i class="fas fa-envelope bg-blue"></i>
                            <div class="timeline-item">
                                <span class="time"><i class="fas fa-clock"></i> {{ $logItem->created_at->format('H:i A') }}</span>
                                <h3 class="timeline-header">{{ $logItem->user_id }} - {{ $logItem->subject }}</h3>
