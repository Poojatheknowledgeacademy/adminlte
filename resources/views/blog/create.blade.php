                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('blogs.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="blog_slug" type="text" class="form-control @error('slug') is-invalid @enderror"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="blog_description"
...
=======
                                    ...
                                    <input type="file" class="form-control @error('featured_img1') is-invalid @enderror"
                                        name="featured_img1" id="blog_image1" value="{{ old('featured_img1') }}">
>>>>>>> 8d37bc9d7edac6b204d3797c7db4c7c0643df5a8
                                    @error('featured_img1')
...
=======
                                            ...
                                            name="featured_img2" id="blog_image2" value="{{ old('featured_img2') }}">
>>>>>>> 8d37bc9d7edac6b204d3797c7db4c7c0643df5a8
                                    </div>
                                    @error('featured_img2')
                                        <div class="error invalid-feedback d-block">{{ $message }}</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text"
                                            ...
                                            name="author_name" id="blog_authorname" value="{{ old('author_name') }}">
                                        @error('author_name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="date" class="form-control @error('added_date') is-invalid @enderror"
                                            name="added_date" id="blog_date" value="{{ old('added_date') }}">
                                        @error('added_date')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 @error('tags') is-invalid @enderror" name="tags[]" id="blog_tag" multiple="multiple" style="width: 100%;"
                                        id="pieces">
                                        @foreach ($tags as $tag)
