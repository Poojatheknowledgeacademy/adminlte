                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-12">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('trashedTopic') }}">Trashed Topics</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                                ...
                                                columns: [{
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        render: function(data, type, full, meta) {
                                                            ...
                                                            var restoreUrl = '{{ route('topic.restore', ':id') }}'.replace(':id',
                                                                data);
                                                            var deleteFormId = 'delete-form-' + data;
                                                            var deleteUrl = '{{ route('topic.delete', ':id') }}'.replace(':id',
                                                                data);
